  ...
  <div class="container">
    ...
    if (this.enabled) {
      try {
        ...
        // Save to file for demo purposes even if real email was sent
        require('fs').writeFileSync('c:\\combined toolkit\\last_email.html', html);
        return true;
      } catch (err) {
      ...
      try {
        require('fs').writeFileSync('c:\\combined toolkit\\last_email.html', html);
        console.log("Email content saved to c:\\combined toolkit\\last_email.html for demo viewing.");
      } catch(e) {
